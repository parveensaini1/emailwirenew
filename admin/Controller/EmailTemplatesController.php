...
class EmailTemplatesController extends AppController {
    ...
    public function beforeFilter() {
        parent::beforeFilter();
        $this->set('controller', 'emailTemplates');
        $this->set('model', 'EmailTemplate');
    }
    ...
    public function index() {
        $this->set('title_for_layout', 'Email template list');
        $this->paginate = array('conditions'=>["id !="=>30],'order' => 'EmailTemplate.id desc', 'limit' =>Configure::read('Admin.paging'));
        $pageList = $this->paginate('EmailTemplate');
