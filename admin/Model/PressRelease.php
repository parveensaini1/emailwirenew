...
class PressRelease extends AppModel {
    ...
    public $hasMany = array('PressSeo', 'PressYoutube', 'PressImage','PressPoadcast');

    public $belongsTo = array('Plan','Company','StaffUser');
    ...
    public function beforeSave($options = array()) {
        ...
        // Temprary removed the code for migration the code 
        /*
