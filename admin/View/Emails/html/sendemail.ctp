<table width="800" align="center" cellpadding="0" cellspacing="0"  style="background-color:#faf7f0;">
    <tbody align="center">
        ...
        <tr>
            <td>
                <table width="630" align="center" cellpadding="0" cellspacing="0"  style="background-color:#fff;padding: 38px;border:7px solid #d9d6d0;margin:auto; ">
                    <tbody align="center">
                        <tr>
                            <td style="text-align:left; font-size:20px; color:#082833; font-weight:bold; display:block;">Hello <?php echo $name.', ';?></td>
                        </tr>
                        <tr>
