                            ...
                            <div id="form-sec" class="">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6 form-group ew-personal-picture">
                                        ...
                                        <div class="row dynamic_proimage">
                                            ...
                                            if ($userData['profile_image'] != '') {
                                                echo $this->Html->image(SITEFRONTURL . 'files/profile_image/' . $userData['profile_image'], array('class' => 'user-image', "id" => "croped_profile_image", "width" => "150px"));
                                            } else {
                                    ...
                                    <!-- <div class="col-sm-6 form-group">
                                        ...
                                        <?php // echo $this->Form->input($model . '.fax_number', array("type" => 'text', 'maxlength' => "15", 'onkeypress' => "return isNumber(event)",));
                                        ?>
                                    </div> -->
                                    <div class="col-sm-6 form-group">
                                    ...
                                    <div class="col-sm-12 form-group">
                                        ...
                                        <?php
                                        echo $this->Form->input($model . '.web_site', array("type" => 'text', "required" =>false, 'class' => 'form-control'));
                                        ?>
                                    </div>
                                    ...
                                    <div class="col-sm-6 form-group ew-personal-picture">
                                        ...
                                        <div class="row croped-banner-img-section">
                                            ...
                                            if (isset($this->data[$model]['banner_image']) && $this->data[$model]['banner_image'] != '') {
                                                echo $this->Html->image(SITEFRONTURL . 'files/company/banner/' . $this->data[$model]['banner_path'] . '/' . $this->data[$model]['banner_image'], array('id' => "croped_banner_image", "width" => "100%"));
                                            } else {
                                        ...
                                        <?php
                                            ...
                                            <div id="<?php echo "pimage-" . $i; ?>" style="<?php echo $stylekey; ?>" class="mt-2 row">
                                                <div class="col-sm-5 float-left">
                                                    ...
                                                    ?>
                                                    <label style="display: block;"> Media File <?php echo $label; ?> <a href="#" data-toggle="tooltip" title="Choose image">
                                                ...
                                                <?php 
                                                    if (!empty($this->data['CompanyDocument'][$i]['file_name'])) {
                                                        echo $this->Html->image(SITEFRONTURL . 'files/company/docfile/' . $this->data['CompanyDocument'][$i]['file_path'] . '/' . $this->data['CompanyDocument'][$i]['file_name'], array('id' => "extrafileview-$i",'width'=>'100%'));
                                                    } else {
                                    ...
                                    <div class="col-lg-12 mt-4">
                                        ...
                                        ?>
                                            <div id="<?php echo "ebooklink-" . $ebookLoop; ?>" style="<?php echo $stylekey; ?>" class="col-sm-12">
                                                <div class="col-sm-7 float-left">
                                                    <label>E-Book Embedded code <?php // echo $label; ?></label>
                                                ...
                                                <div class="col-sm-5  float-left">
                                                    <label>Describe E-Book <?php // echo $label; ?></label>
                                        ...
                                        ?>
                                            <div id="<?php echo "podlink-" . $podloop; ?>" style="<?php echo $stylekey; ?>" class="col-sm-12">
                                                <div class="col-sm-7 float-left">
                                                    ...
                                                    <?php echo $this->Form->input("CompanyPodcast.$podloop.embedded", array('label' => false, 'type' => 'textarea', 'id' => "podsentationEmbedded$podloop")); ?>
                                                </div>
                                                <div class="col-sm-5  float-left">
