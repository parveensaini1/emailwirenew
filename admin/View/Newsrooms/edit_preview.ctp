    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">
                    <?php echo $this->Html->link(__("Back to Edit"), array('controller' =>'newsrooms','action' =>"edit_newsroom",$data[$model]['company_id'],$returnType), array('class' => 'btn btn-primary mr-4',));?>
                ...
                <div class="card-tools">
                    ...
                    echo $this->Form->input("$model.company_id", array("type" => "hidden","value"=>$data[$model]['company_id']));
                            ...
                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link <?php if ($newsroomFilter == 'prnews') {
                                                            echo "active";
                                                        } ?>" href="<?php echo SITEURL . 'newsrooms/edit_preview/' . $tempId.'/'.$returnType; ?>">Press Releases</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link <?php if ($newsroomFilter == 'companyassets') {
                                                            echo "active";
                                                        } ?> " href="<?php echo SITEURL . 'newsrooms/edit_preview/' . $tempId .'/'.$returnType. '/companyassets'; ?>">Media Assets</a>
                                </li>

                                <li class="nav-item">
                                    <a class="nav-link <?php if ($newsroomFilter == 'social') {
                                                            echo "active";
                                                        } ?>" href="<?php echo SITEURL . 'newsrooms/edit_preview/' . $tempId .'/'.$returnType. '/social'; ?>" role="tab">Social Media</a>
                                </li>
                                
                                <li class="nav-item">
                                    <a class="nav-link <?php if ($newsroomFilter == 'mediacontact') {
                                                            echo "active";
                                                        } ?>" href="<?php echo SITEURL . 'newsrooms/edit_preview/' . $tempId .'/'.$returnType. '/mediacontact'; ?>">Media Contact</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link <?php if ($newsroomFilter == 'aboutus') {
                                                            echo "active";
                                                        } ?>" href="<?php echo SITEURL . 'newsrooms/edit_preview/' . $tempId .'/'.$returnType. '/aboutus'; ?>">About Us</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link <?php if ($newsroomFilter == 'location') {
                                                            echo "active";
                                                        } ?>" href="<?php echo SITEURL . 'newsrooms/edit_preview/' . $tempId .'/'.$returnType. '/location'; ?>">Location</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link <?php if ($newsroomFilter == 'contactus') {
                                                            echo "active";
                                                        } ?>" href="<?php echo SITEURL . 'newsrooms/edit_preview/' . $tempId .'/'.$returnType. '/contactus'; ?>">Contact Us</a>
                                </li>
                            </ul>
