    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">
                    <?php echo $this->Html->link(__("<< Back"), array('controller' => 'newsrooms', 'action' => $returnType), array('class' => 'btn btn-primary mr-4',)); ?>
                            ...
                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link <?php if ($newsroomFilter == 'prnews') {
                                                            echo "active";
                                                        } ?>" href="<?php echo SITEURL . 'newsrooms/view/' . $slug . '/prnews/' . $returnType; ?>">Press Releases</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link <?php if ($newsroomFilter == 'companyassets') {
                                                            echo "active";
                                                        } ?> " href="<?php echo SITEURL . 'newsrooms/view/' . $slug . '/' . $returnType . '/companyassets'; ?>">Media Assets</a>
                                </li>
                               
                                <li class="nav-item">
                                    <a class="nav-link <?php if ($newsroomFilter == 'social') {
                                                            echo "active";
                                                        } ?>" href="<?php echo SITEURL . 'newsrooms/view/' . $slug . '/' . $returnType . '/social'; ?>" role="tab">Social Media</a>
                                </li>
                               
                                <li class="nav-item">
                                    <a class="nav-link <?php if ($newsroomFilter == 'mediacontact') {
                                                            echo "active";
                                                        } ?>" href="<?php echo SITEURL . 'newsrooms/view/' . $slug . '/' . $returnType . '/mediacontact'; ?>">Media Contact</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link <?php if ($newsroomFilter == 'aboutus') {
                                                            echo "active";
                                                        } ?>" href="<?php echo SITEURL . 'newsrooms/view/' . $slug . '/' . $returnType . '/aboutus'; ?>">About Us</a>
                                </li>

                                <li class="nav-item">
                                    <a class="nav-link <?php if ($newsroomFilter == 'location') {
                                                            echo "active";
                                                        } ?>" href="<?php echo SITEURL . 'newsrooms/view/' . $slug . '/' . $returnType . '/location'; ?>">Location</a>
                                </li>
                                
                                <li class="nav-item">
                                    <a class="nav-link <?php if ($newsroomFilter == 'contactus') {
                                                            echo "active";
                                                        } ?>" href="<?php echo SITEURL . 'newsrooms/view/' . $slug . '/' . $returnType . '/contactus'; ?>">Contact Us</a>
                                </li>
                            </ul>
