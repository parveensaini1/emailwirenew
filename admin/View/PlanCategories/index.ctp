                        ...
                        <tbody>
                            ...
                            if (count($data_array) > 0) {
                                ...
                                foreach ($data_array AS $key=>$value) {
                                    ...
                                    // $actions .= ' ' . $this->Html->link(__('Delete'), array(         'controller' => $controller,'action' => 'delete',$key,), array('class' => 'btn btn-xs btn-danger', 'onclick' => 'return confirmAction(this.href);'));
