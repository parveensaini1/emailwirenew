               ...
               echo $this->Form->input('id');
                ...
                if(!empty($this->data[$model]['plan_type'])){?>
                    <div class="row">                        
                        ...
                        <?php 
                        if(!empty($this->data[$model]['translation_amount']) && $this->data[$model]['translation_amount'] != 0){
                        ?>
                            <div class="col-sm-12">
                                <div id="translationbox">
                                    <?php
                                        echo $this->Form->input("Plan.translation_amount", array('type' =>'text','class' => 'form-control','label' => 'Translation amount'));
                                    ?>
                            </div>
                        </div>
                        <?php
                    ...
                    <?php if($this->data[$model]['plan_type']=='bulk'){ ?>
                        <div class="row">
                            <div class="col-sm-12">
                    ...
                    <!-- <?php //if($this->data[$model]['plan_type']=='single'){?> -->
                    <?php if($this->data[$model]['plan_type']==''){?>
                        <div class="row">
                          <!--   <div class="col-sm-12">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            echo '<label for="PlanCategoryLimit">Number of category allowed - (Total categories '.$maxCategroy.')</label>';
                            echo $this->Form->input('category_limit', array('type' => 'number','label'=>false,'min'=>'1','max'=>$maxCategroy));  
                            ?>
                        </div>
                        <div id="bulk-in-single" class="col-sm-12">
                            <?php echo $this->Form->input('add_category_charges', array('type' => 'text','label'=>"Additional charges for each allowed category"));?>
                        </div>
                    </div>
                    ...
                    <div class="row">
                       <div class="col-sm-12">
                            ...
                            echo '<label for="PlanCategoryLimit">Number of MAS allowed - (Total MSA '.$maxMsa.')</label>';
                            echo $this->Form->input('msa_limit', array('type' => 'number','label'=>false,'min'=>'1','max'=>$maxMsa));  
                            ?>
                        </div>
                        <div id="bulk-in-single" class="col-sm-12">
                    ...
                    <div class="row">
                       <div class="col-sm-12">
                            ...
                            echo $this->Form->input('state_limit', array('type' => 'number','label'=>false,'min'=>'1','max'=>$maxState));  
                            ?>
                        </div>
                        <div id="bulk-in-single" class="col-sm-12">
                    ...
                    <?php     echo $this->Form->input('status', array('div' => 'form-group div-status', 'class' => 'custom_check','type'=>'checkbox'));
