<div class="row">
    ...
    <div class="col-lg-12">
        <div class="card card-default">
            <div class="card-body "> 
                <div class="col-lg-12">
                        <div class="ew-title row <?php echo $this->Post->classAccordingToLanguage($data[$model]['language']);  ?>"> 
                            <?php echo $pr_data['PressRelease']['title']; ?>
                        </div>
                    </div>
                ...
                <div class="dataTable_wrapper">
                   ...
                   <div class="ew-title full row">
                        ...
                        <div class="col-lg-6">
                            <div class="row">
                            <?php echo $this->Form->create('Search', array('url'=>SITEURL.'PressReleases/viewreport/'.$prId.'/','type' => 'get', 'inputDefaults' => array('div' => 'form-group', 'class' => 'form-control form-inline', 'required' => false))); ?>
