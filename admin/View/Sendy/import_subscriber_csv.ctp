        ...
        <div class="card card-default"> 
            ...
            <div class="card-body">
                ...
                <div class="dataTable_wrapper">
                	...
                	<!-- <p><a href="<?php echo SITEURL.'sendy';?>/subscribers?i=<?php echo $appId;?>&l=<?php echo $lid;?>"><span class="label label-info"><?php echo $data[$model]['name'];?></span></a> </p>-->
                	

                	<p><?php echo _('List');?>: <a href="<?php echo SENDYURL;?>subscribers?i=<?php echo $appId;?>&l=<?php echo $lid;?>"><span class="label label-info"><?php echo $data[$model]['name'];?></span></a>	</p><br/>

                    <?php echo $this->Form->create("List", array('url' => SENDYURL.'includes/subscribers/import-update-admin.php','type'=>'file','novalidate', 'inputDefaults' => array('div' => 'form-group', 'class' => 'form-control'),'id'=>"import-update-form")); ?>
                    <div class="row">
                        <div class="col-sm-12">
	                	<?php if($err==1):?>
	                        ...
	                        <div class="row">
		                        <div class="col-md-6">
	    	                        <label>&nbsp;</label>
	        	                    <?php
	            	                    echo $this->Form->submit('Import list', array('class' => 'btn btn-info', 'div' => false));
	               		             ?>
	                        	</div>  
	                    	</div>
                        </div>
