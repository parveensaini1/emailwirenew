                                ...
                                foreach ($data_array AS $index =>$data) { 
									...
									if ($data[$model]['staff_role_id'] == 3) {
                                     $actions .= ' ' . $this->Html->link(__('Company list'), array('controller' => $controller, 'action' => 'clientcompanies', $data[$model]['id'],$redirect), array('class' => 'btn btn-xs btn-primary'));
                                        ...
                                        $actions .= ' ' . $this->Html->link(__('Press Releases'), array('controller' => $controller, 'action' => 'clientcompanies', $data[$model]['id'],$redirect), array('class' => 'btn btn-xs btn-warning'));
                                    ...
                                    if($data[$model]['subscriber_type'] == 1){
                                            $subscriber_type    =   'Journalist';
                                    }else if($data[$model]['subscriber_type'] == 2){
                                            $subscriber_type    =   'Bloggers';
                                    }else if($data[$model]['subscriber_type'] == 3){
