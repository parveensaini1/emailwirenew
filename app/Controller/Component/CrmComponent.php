...
class CrmComponent extends Component {
    ...
    public function searchRecord($email){
        ...
        curl_setopt_array($curl, array(
            CURLOPT_URL => "https://www.zohoapis.com/crm/v7/Leads/search?email=$email",
        ...
        return empty($desc_resp) ? null : (isset($desc_resp["data"]) ? $desc_resp["data"][0]["id"] : null);
    }
    ...
    public function convertLeadToContact($leadId) {
    ...
    "data" => [
        ...
        $curl = curl_init();
        curl_setopt_array($curl, array(
            CURLOPT_URL => "https://www.zohoapis.com/crm/v7/Leads/$leadId/actions/convert",
            CURLOPT_RETURNTRANSFER => true,
            CURLOPT_ENCODING => '',
            CURLOPT_MAXREDIRS => 10,
            CURLOPT_TIMEOUT => 0,
...
//die($response);
       ...
       return true;
        ...
        // if(isset($desc_resp['data'][0]['code'])){
        //   if($desc_resp['data'][0]['code'] == 'SUCCESS'){
        //         return ['status' => true, 'message' => "Lead Converted to Contact Successfully."];
        //   }
        // }
