...
class UploadHandler {
    ...
    function __construct($options = null, $initialize = true, $error_messages = null) {
        ...
        $this->options = array(
            'script_url' => SITEFRONTURL,
            'upload_dir' => GLOBALWEBROOT . $options['target_folder'],
            'upload_url' => SITEFRONTURL . $options['target_folder'],
            'user_dirs' => true,
            'mkdir_mode' => 0755,
            'param_name' => 'files',
...
//                substr($_SERVER['SCRIPT_NAME'], 0, strrpos($_SERVER['SCRIPT_NAME'], '/'));
    ...
    protected function set_additional_file_properties($file) {
        $file->deleteUrl = SITEURL . 'hotels/upload_files/?file=' . rawurlencode($file->name);
    ...
    protected function trim_file_name($file_path, $name, $size, $type, $error, $index, $content_range) {
        ...
        $name = time() . uniqid().trim(basename(stripslashes($name)), ".\x00..\x20");
