 <footer class="ew-footer1 full mt-2 p-4" id="footernewsroom">
         ...
         <div class="full ew-footer-logo-social margin-bottom30">
             <div class="row">
                 ...
                 <div class="ew-pr-social col-sm-6 text-center">
                     <?php
                        echo $this->Post->sharelinks($data[$model]['job_title'], SITEURL . 'newsroom/' . $data[$model]['slug'], substr(strip_tags($data[$model]['description']), 0, 255) . '...', SITEURL . 'files/company/logo/' . $data[$model]['logo_path'] . '/' . $data[$model]['logo']);
                        ?>
                 </div>
