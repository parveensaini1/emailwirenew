...
<div id="cartsection" class="orange-border"  <?php if($total_amount<=0){?> style="display: none;" <?php } ?>  >
    ...
    <div class="ew-cart-dis-block full">
     ...
     <!-- <div class="buy_now_section">
        <a id="checkoutbtn" href="javascript:void(0)" onclick="submitform('submitwithpayment');" class="btn orange-btn">Checkout and Submit Press Release</a>
    </div> --> 
 </div>
 <?php /*
