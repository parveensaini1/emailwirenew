                ...
                <div class="box box-danger">
                    ...
                    <div class="box-body">
                        <div class="row">
                            ...
                            <div class="col-xs-2">
                                <?php echo $this->Form->input('city_id', array('id' => 'city_id', 'data-type' => 1, 'empty' => 'Select City')); ?>
                            </div>
                            <div class="col-xs-4">
                                <?php echo $this->Form->input('school_id', array('id' => 'school_id', 'empty' => 'Select School')); ?>
                            </div>
                            <div class="col-xs-2">
...
<script>
<?php if (isset($this->params->query['school_id']) && $this->params->query['school_id'] != '') { ?>
        $(window).load(function () {
            get_states("<?php echo $this->params->query['state_id']; ?>");
            get_cities("<?php echo $this->params->query['city_id']; ?>");
            get_registered_schools("<?php echo $this->params->query['school_id']; ?>");
        });
<?php } ?>
</script>