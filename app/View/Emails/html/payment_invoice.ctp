<table width="600" align="center" cellpadding="0" cellspacing="0"  style="background-color:#faf7f0;">
    <thead align="center">
        <tr>
    ...
    <tbody align="center">
        ...
        <tr>
          <td><h1 style="text-align:left; font-size:20px; color:#082833; font-weight:bold; margin:0; padding:0;">Dear <?php echo ucfirst($name); ?></h1></td>
        </tr> 
        <tr>
        ...
        <tr><td>
                <table width="600" align="center" cellpadding="0" cellspacing="0"  style="background-color:#fff;padding: 38px;border:7px solid #d9d6d0;display:block;margin:auto; ">
                    <tbody align="center">
                      <tr>  <td style="font-size: 0; line-height: 0;" height="20">&nbsp;</td>
                        ...
                        if(!empty($data['TransactionPlan'])){
                            foreach ($data['TransactionPlan'] as $plan){?>
                                ...
                                <tr>
                                <td style="font-size:14px; color:#082833; border-bottom:1px solid #f2f2f2; border-right:1px solid #f2f2f2; font-weight:bold; padding: 15px; width: 50%;"><?php echo (isset($plan['title'])&&!empty($plan['title']))?$plan['title']:""; ?></td>

                                <td style="font-size:14px; color:#000000; border-bottom:1px solid #f2f2f2; font-weight:400; padding: 15px; width: 50%;"><?php
                                $amount=isset($plan['plan_amount']&&!empty($plan['plan_amount']))?$plan['plan_amount']:""
                                 echo $currency.' '.$amount;?></td>
                                </tr>
