...
<head>
    ...
    <!-- Theme style -->
    <!-- <link rel="stylesheet" href="<?php echo SITEURL; ?>plugins/AdminLTE-master/dist/css/AdminLTE.min.css"> -->
    <!-- AdminLTE Skins. Choose a skin from the css/skins
             folder instead of downloading all of them to reduce the load. -->
    <link rel="stylesheet" href="<?php echo SITEURL; ?>plugins/AdminLTE-master/dist/css/skins/_all-skins.min.css">
    <?php
    echo $this->Html->css(
        array(
    ...
    echo $this->Html->script(
        array(
            ...
            // 'https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/js/bootstrap.min.js',
            // '/plugins/AdminLTE-master/dist/js/app.min',
            // '/plugins/AdminLTE-master/dist/js/demo',
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            <div class="container" style="max-width: 100%; ">
                <?php if ($this->layout == 'site_default') { ?>
                    <div class="container">
                    <?php
                        }
                    ?>
