                  ...
                  <div class="company-dtails">
                    <?php if($data['Company']['logo']){ ?>
                     <div class="ew-comany-logo float-left">
                         ...
                         <?php echo $this->Post->getNewsroomLogo($data['Company']['logo_path'],$data['Company']['logo'],$data['Company']['status']);?></div>
                     </div>
                   <?php } ?>
                ...
                <div class="summarybox">
                  <?php if(!empty($data['PressImage'])){ ?>
                    <div class="post_image">
                        <a href="<?php echo SITEURL."release/".$data['PressRelease']['slug'];?>">
