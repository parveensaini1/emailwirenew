         ...
         <div class="ew-title full"><?php echo $title;?></div>
          ...
          if(!empty($data_array)){
            ...
            <article class="<?php echo $this->Post->classAccordingToLanguage($data[$model]['language']);?>">
                <h4 class="box-title"><a href="<?php echo SITEURL.'release/'.$data[$model]['id']; ?>"><?php echo ucfirst($data[$model]['title']); ?></a>  </h4>
                    <div class="company-dtails">
                      ...
                      <?php } ?>
                      <div id="prev_company_name" class="ew-compnay">
                      <?php echo $this->Post->get_company($data['Company']['name'],$data['Company']['slug'],$data['Company']['status']); ?> - <span class="release_date"><?php echo date($dateformate,strtotime($data[$model]['release_date']));?></span>    
                      </div>  
                    </div>
                ...
                <?php if(!empty($data[$model]['summary'])){ ?>                
                  <div class="summarybox">
                    <?php  if(!empty($data['PressImage'])){ ?>
                      ...
                      <a href="<?php echo SITEURL."release/".$data[$model]['id'];?>">
