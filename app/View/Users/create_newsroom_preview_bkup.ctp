                            ...
                            <div class="col-sm-9 ew-newsroom-right-section">
                                ...
                                <div class="ew-newsroom-tabing full">
                                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                                        <li class="nav-item">
                                        <a class="nav-link <?php if($newsroomFilter=='prnews'){echo "active"; } ?>" href="<?php echo SITEURL.'users/newsroom-preview'; ?>">Company News</a>
                                        </li>
                                        <li class="nav-item">
                                        <a class="nav-link <?php if($newsroomFilter=='social'){echo "active"; } ?>" href="<?php echo SITEURL.'users/newsroom-preview/social'; ?>" role="tab">Social</a>
                                        </li>
                                        <li class="nav-item">
                                        <a class="nav-link <?php if($newsroomFilter=='companyassets'){echo "active"; } ?> " href="<?php echo SITEURL.'users/newsroom-preview/companyassets'; ?>">Company assets</a>
                                        </li>
                                        </ul>
