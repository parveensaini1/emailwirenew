                            ...
                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link <?php if ($newsroomFilter == 'prnews') {
                                                            echo "active";
                                                        } ?>" href="<?php echo SITEURL . 'users/edit_preview/' . $data[$model]['slug'].'/prnews/'.$returnType; ?>">Press Releases</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link <?php if ($newsroomFilter == 'companyassets') {
                                                            echo "active";
                                                        } ?> " href="<?php echo SITEURL . 'users/edit_preview/' . $data[$model]['slug'] .'/companyassets/'.$returnType; ?>">Media Assets</a>
                                </li>

                                <li class="nav-item">
                                    <a class="nav-link <?php if ($newsroomFilter == 'social') {
                                                            echo "active";
                                                        } ?>" href="<?php echo SITEURL . 'users/edit_preview/' . $data[$model]['slug'] .'/social/'.$returnType; ?>" role="tab">Social Media</a>
                                </li>
                               
                                <li class="nav-item">
                                    <a class="nav-link <?php if ($newsroomFilter == 'mediacontact') {
                                                            echo "active";
                                                        } ?>" href="<?php echo SITEURL . 'users/edit_preview/' . $data[$model]['slug'] .'/mediacontact/'.$returnType; ?>">Media Contact</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link <?php if ($newsroomFilter == 'aboutus') {
                                                            echo "active";
                                                        } ?>" href="<?php echo SITEURL . 'users/edit_preview/' . $data[$model]['slug'] .'/aboutus/'.$returnType; ?>">About Us</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link <?php if ($newsroomFilter == 'location') {
                                                            echo "active";
                                                        } ?>" href="<?php echo SITEURL . 'users/edit_preview/' . $data[$model]['slug'] .'/location/'.$returnType; ?>">Location</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link <?php if ($newsroomFilter == 'contactus') {
                                                            echo "active";
                                                        } ?>" href="<?php echo SITEURL . 'users/edit_preview/' . $data[$model]['slug'] .'/contactus/'.$returnType; ?>">Contact Us</a>
                                </li>
                            </ul>
