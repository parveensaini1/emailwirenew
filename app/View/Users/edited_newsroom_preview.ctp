        ...
        <div class="modal-content">
            <div class="modal-header">
             ...
             if($this->data['Company']['banner_image'] != ''){
                echo $this->Html->image(SITEURL.'files/company/banner/'.$this->data['Company']['banner_path'].'/'.$this->data['Company']['banner_image'], array('id'=>"prev_banner_image"));
             }else{
            ...
            <div class="modal-body full ew-sub-page ew-newsroom-block">
                            ...
                            <div class="col-sm-3 ew-newsroom-left-user">
                                <div class="full ew-newsromm-user margin-bottom15">
                                    ...
                                    if ($this->data['Company']['logo']!= '') {
                                     echo $this->Html->image(SITEURL.'files/company/logo/'.$this->data['Company']['logo_path'].'/'.$this->data['Company']['logo'], array('width'=>"100%",'id'=>'prev_logo_image'));
                            ...
                            <div class="col-sm-9 ew-newsroom-right-section">
                                ...
                                <div class="ew-newsroom-tabing full">
                                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                                        <li class="nav-item">
                                        <a class="nav-link <?php if($newsroomFilter=='prnews'){echo "active"; } ?>" href="<?php echo SITEURL.'users/edited-newsroom-preview'; ?>">Company News</a>
                                        </li>
                                        <li class="nav-item">
                                        <a class="nav-link <?php if($newsroomFilter=='social'){echo "active"; } ?>" href="<?php echo SITEURL.'users/edited-newsroom-preview/social'; ?>" role="tab">Social</a>
                                        </li>
                                        <li class="nav-item">
                                        <a class="nav-link <?php if($newsroomFilter=='companyassets'){echo "active"; } ?> " href="<?php echo SITEURL.'users/edited-newsroom-preview/companyassets'; ?>">Company assets</a>
                                        </li>
                                    </ul>
                                                                ...
                                                                <div class="col-sm-4 ew-latest-news-post margin-bottom20">
                                                                    <div class="full ew-latest-news-inner"> 
                                                                        <div class="orange-border ew-lastest-news-img-single full relative">
                                                                            <?php 
                                                                            echo $this->Html->image(SITEURL.'website/img/news-8.jpg', array('class' => 'user-image',"id"=>"prev_profile_image", "width"=>"100%"));
                                                                            ?> 
                 
                                                                            <div class="ew-date-sm ew-absolute-date"><?php echo date('F d, Y'); ?></div>
                                                                        </div>
                                                                        <div class="full ew-lastest-news-single-content">
                                                                            <a class="ew-link-title" href="#">This is a dummy preview title.</a> 
                                                                                            ...
                                                                                            <?php 
                                                                                                if ($this->data['Company']['logo']!= '') {
                                                                                                 echo $this->Html->image(SITEURL.'files/company/logo/'.$this->data['Company']['logo_path'].'/'.$this->data['Company']['logo'], array('width'=>"100%",'id'=>'prev_logo_image'));
                                                                                                    ...
                                                                                                    echo $this->Html->image(SITEURL.'website/img/news-8.jpg', array('class' => 'user-image',"id"=>"prev_logo_image", "width"=>"100%"));
                                                                                                }
                                                                                                ?> 
                                                                                        </div>
                                                                                    </div>
                ...
                <a class="btn btn-default" href="<?php echo SITEURL.'users/edit-newsroom/'.$this->data['Company']['id'];?>" >Go back and Edit</a> 
                  <?php
                ...
                echo $this->Form->input('Proceed with this newsroom', array("type" => 'submit', 'class'=>"btn btn-primary",'id'=>'continuebtn','label'=>false));
