	...
	function twentynineteen_setup() {
		...
		register_nav_menus(
			array(
				...
				'menu-2' => __( 'Top Bar', 'twentynineteen' ),
...
function twentynineteen_widgets_init() {
	...
	register_sidebar(
		array(
			'name'          => __( 'Header Ad', 'twentynineteen' ),
			'id'            => 'sidebar-1',
			'description'   => __( 'Add widgets here to appear on top of your Header.', 'twentynineteen' ),
	...
	register_sidebar(
		array(
			'name'          => __( 'Content Ad', 'twentynineteen' ),
			'id'            => 'sidebar-2',
			'description'   => __( 'Add widgets here to appear on home page.', 'twentynineteen' ),
			'before_widget' => '<section id="%1$s" class="widget %2$s">',
			'after_widget'  => '</section>',
			'before_title'  => '<h2 class="widget-title">',
			'after_title'   => '</h2>',
	...
	register_sidebar(
		array(
			'name'          => __( 'Footer popup', 'twentynineteen' ),
			'id'            => 'sidebar-4',
			'description'   => __( 'Add widgets here to appear in your footer.', 'twentynineteen' ),
			'before_widget' => '<section id="%1$s" class="widget %2$s">',
			'after_widget'  => '</section>',
	...
	register_sidebar(
		array(
			...
			'id'            => 'sidebar-5',
			'description'   => __( 'Add widgets here to appear in your post pages.', 'twentynineteen' ),
			'before_widget' => '<section id="%1$s" class="widget %2$s">',
			'after_widget'  => '</section>',
			'before_title'  => '<h2 class="widget-title">',
			'after_title'   => '</h2>',
	...
	register_sidebar(
		array(
			'name'          => __( 'Footer Widget', 'twentynineteen' ),
			'id'            => 'sidebar-6',
			'description'   => __( 'Add widgets here to appear in your post and pages footer.', 'twentynineteen' ),
			'before_widget' => '<section id="%1$s" class="widget %2$s">',
			'after_widget'  => '</section>',
			'before_title'  => '<h2 class="widget-title">',
			'after_title'   => '</h2>',
 ...
 */
include_once(TEMPLATEPATH . '/inc/resize.php');
