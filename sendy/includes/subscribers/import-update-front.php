...
if(!file_exists($csvfile)) {
	...
	echo '<script type="text/javascript">window.location="'.addslashes(SITEURL."/users/import-media-email-list/".$listID."?e=3").'";</script>';
	exit;
}
...
foreach ($csv->data as $key => $line){	
	...
	if($cron){
		if(!file_exists("../../uploads/csvs")){
			...
			echo '<script type="text/javascript">window.location="'.addslashes(SITEURL."/users/import-media-email-list/".$listID."?e=4").'";</script>';
			exit;
			}else{
				//chmod uploaded file
		...
		if($columns != $custom_fields_count+2){
			...
			echo '<script type="text/javascript">window.location="'.addslashes(SITEURL."/users/import-media-email-list/".$listID."?e=1").'";</script>';
			exit;
		}else{
			...
			if(move_uploaded_file($csvfile, "../../uploads/csvs/".$userID.'-'.$listID.'.csv')){
				...
				// header("Location: ".get_app_info('path').'/list?i='.$app); 
				 echo '<script type="text/javascript">window.location="'.addslashes(SITEURL."/users").'";</script>';
					exit;
			}
...
echo '<script type="text/javascript">window.location="'.addslashes(SITEURL."/users/client-media-list/".$listID).'";</script>';
